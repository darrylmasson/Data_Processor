...
class XSQ : public Method {
	private:
		...
		static double xsq_n[3]; // only three detectors - number of channels irrelevant
		static double peakheight_n[3];
		static double baseline_n[3];
		static double offset_n[3];
		static double peak_err_n[3];
		static double base_err_n[3];
		static double offset_err_n[3];
		
		static double xsq_y[3];
		static double peakheight_y[3];
		static double baseline_y[3];
		static double offset_y[3];
		static double peak_err_y[3];
		static double base_err_y[3];
		static double offset_err_y[3];
		
		static int fit_status_n[3];
		static int fit_status_y[3];
	...
	public:
		...
		static void root_deinit()	{XSQ::tree.reset();}
